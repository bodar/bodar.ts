...
describe("HTMLTransformer", () => {
    test("constants are not rendered, so no placeholder slot", async () => {
        ...
        expect(result).toBe(`<body><script type="module">import {Renderer, JSX2DOM} from "@bodar/dataflow/runtime.ts";
...
renderer.render();</script></body>`);
    ...
    test("single expressions will create a placeholder display slot", async () => {
        ...
        expect(result).toBe(`<body><slot name="_display_4vhz4q"></slot><script type="module">import {Renderer, JSX2DOM} from "@bodar/dataflow/runtime.ts";
const renderer = new Renderer();
renderer.register("jsx", [], [], () => new JSX2DOM());
renderer.register("vge10p",[],["a"],() => {
const a = 1;
...
renderer.render();</script></body>`);
    ...
    test("can provide an id/key via HTML id attribute", async () => {
        ...
        expect(result).toBe(`<body><slot name="_display_constant"></slot><script type="module">import {Renderer, JSX2DOM} from "@bodar/dataflow/runtime.ts";
const renderer = new Renderer();
renderer.register("jsx", [], [], () => new JSX2DOM());
...
renderer.render();</script></body>`);
    ...
    test("if the javascript is invalid, report the error in the slot", async () => {
        ...
        expect(result).toBe(`<body><slot name="_display_00001p"></slot><script type="module">import {Renderer, JSX2DOM} from "@bodar/dataflow/runtime.ts";
const renderer = new Renderer();
renderer.register("jsx", [], [], () => new JSX2DOM());
...
renderer.render();</script></body>`
    ...
    test("data-echo inserts escaped code block after output", async () => {
        ...
        expect(result).toBe(`<body><pre><code class="language-javascript">1 + 2</code></pre><slot name="_display_0rj9ce"></slot><script type="module">import {Renderer, JSX2DOM} from "@bodar/dataflow/runtime.ts";
const renderer = new Renderer();
renderer.register("jsx", [], [], () => new JSX2DOM());
