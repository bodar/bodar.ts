 ...
 * @module
 *
 * DuckDB WASM database records interface using Connection with type-safe query building.
 */
...
/**
 * DuckDBWasmRecords provides type-safe database operations for DuckDB WASM.
 * Uses Connection for query execution and transaction control.
 */
export class DuckDBWasmRecords implements Records {
    /**
     * Creates a new instance of DuckDBWasmRecords.
     *
