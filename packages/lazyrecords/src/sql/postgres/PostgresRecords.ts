 ...
 * @module
 *
 * PostgreSQL database records interface using Connection with type-safe query building.
 */
...
/**
 * PostgresRecords provides type-safe database operations for PostgreSQL.
